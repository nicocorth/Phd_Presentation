...
\centering
\onslide<2->{
\includegraphics[height = 3.5 cm]{./breaking_bad_crossed.jpg}}
\onslide<3->{
\hfill\includegraphics[height=3.5 cm]{./koen.jpg}\hfill\includegraphics[height =3.5 cm]{./thierry.jpg}
\begin{framed}
\centering
...
\includegraphics[height=.21\linewidth]{ice_cubes.jpg} & \includegraphics[height=.21\linewidth]{eau_liquide.jpg} & \includegraphics[height=.21\linewidth]{bouilloire.jpg}\\
...
\begin{frame}{Thesis objective and research questions}
...
\begin{frame}{General equation for plasma at LTE}
\begin{framed}
\begin{equation*}
	\left\{
	\begin{aligned}
