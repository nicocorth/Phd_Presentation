...
Provided $Kn \ll 1$ (continuous medium) + conservation of mass, momentum and energy, it is possible to simplify this system by integration over the velocity space.
...
\begin{tikzpicture}[scale = .6]
	...
	\draw (12,3.8) node[above]{Opening};
...
\textbf{In order to stabilize the solver, a fictive temporal term is added.}
...
with
\begin{equation*}
E_P = \sqrt{\gamma} E_P' \quad E_C = \sqrt{\gamma} E_C', \qquad \gamma = \frac{P_{target}}{\int_{NS}P_J' dV}
\end{equation*}
...
\end{itemize}
\end{minipage}
\hfill\begin{minipage}{.49\linewidth}
\centering
The coflow $\chi$ is defined as
\begin{equation*}
...
{
\begin{framed}
\textbf{We have a fast and robust solver for ICP, able to produce meaningful results in 20 minutes of time on a single laptop using 8 OMP threads!}
\end{framed}
}
