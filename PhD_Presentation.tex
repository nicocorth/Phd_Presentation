...
\begin{frame}[c]{Presentation and experience}
\centering
\begin{minipage}{0.29\linewidth}
\includegraphics[width=.95\linewidth]{photoNico.jpg}
\end{minipage}
\begin{minipage}{0.69\linewidth}
\begin{description}
\item[[2015$\rightarrow$2020]] Master in Physics Engineering
\item[[2020$\rightarrow$2021]] Research master at VKI.
\item[[2021$\rightarrow$2025]] Ph. D. on ICP simulations.
\item[[2025$\rightarrow$Now]] Software Developer at Spacebel.
\item[[2019$\rightarrow$Now]] Experience with DG.
\end{description}
\end{minipage}
\begin{framed}
I developed a \textbf{high-order numerical solver} for \textbf{inductively coupled plasma} (ICP).
\end{framed}
\end{frame}
...
\end{aligned}
\end{equation*}
\includegraphics[width=.3\linewidth]{mpp-logo.png}
\end{minipage}
\begin{minipage}{0.49\linewidth}
\begin{equation*}
\begin{aligned}
