...
\begin{equation*}
\begin{aligned}
& \left(\partial_t \vecw_{h} - \vecS_{h}, \varphi_{K,i} \right)_{K} - \left(\vecF_{c, {h}} - \vecF_{v, {h}}, \nabla \varphi_{K,i} \right)_{K} + \left\langle \vecHcal(\textcolor{red}{\veclambda_h}), \varphi_{K,i} \right\rangle_{\partial K} = 0, \; \forall \varphi_{K,i} \in W_h\\
& \left(\vecq_h, \vectau_{K,i}\right)_{K} - \left(\vecu_h, \nabla \vectau_{K,i}\right)_{K} + \left\langle \textcolor{red}{\veclambda_h}, \vectau_{K,i} \cdot \vecn \right\rangle_{\partial K_0} + \left\langle \vecu_{bc}, \vectau_{K,i} \cdot \vecn \right\rangle_{\partial K_{bc}} = 0, \forall \vectau_{K,i} \in V_h
\end{aligned}
\end{equation*}
\end{framed}
...
\only<1>
{
\hspace{-1.3cm}\input{./Convergence_Study_Plot_p_0} &
\input{./Convergence_Study_Plot_u_0}
}
\only<2>
{
\hspace{-1.3cm}\input{./Convergence_Study_Plot_v_0} & \input{./Convergence_Study_Plot_T_0}
}
\end{tabular}
\only<3>
{
...
\only<1>
{
\hspace{-1.3cm}\input{./Convergence_Study_Plot_EpRe_0} & \input{./Convergence_Study_Plot_EpIm_0}
}
\only<2>
{
\hspace{-1.5cm}\input{./Convergence_Study_Plot_EpRe_1} & \input{./Convergence_Study_Plot_EpIm_1}
}
\end{tabular}
