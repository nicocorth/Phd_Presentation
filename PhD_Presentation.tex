...
\onslide<4->{
\begin{framed}
\textbf{Développement de dispositifs expérimentaaux reproduisant les plasmas de réentrée atmosphérique.}
\end{framed}
}
\end{frame}
...
{
\begin{framed}
\textbf{Les volumes finis nécessitent un maillage très fin dans les régions de grande variation ou de géométrie complexe.}
\end{framed}
...
%($\bullet^n$)
exhibiting a \underline{collective} behaviour.}
%A plasma is a quasi-neutral gas of charged and neutral particles which exhibits collective behaviour.
\end{framed}
}
\onslide<2->{
\centering
\begin{framed}
\textbf{Collision = particles interaction}
\end{framed}

\begin{tabular}{cc}
\textbf{Short ranged}} & \onslide<3->{\textbf{Long ranged}}\\
\onslide<2->{
\begin{tikzpicture}
...
\end{tikzpicture}}\\
\onslide<2->{Direct contact (local \& binary)} & \onslide<3->{Electric force (distance and collective)}
\end{tabular}
\onslide<4->{
\begin{framed}
...
\onslide<2->{Chemical equilibrium} & \onslide<3->{Chemical non-equilibrium} & \onslide<4->{Frozen flow}\\
\end{tabular}
\end{center}

\onslide<5->{\textbf{Plasmas are in chemical equilibrium in this work.}}
...
\begin{center}
\begin{tabular}{cc}
\onslide<2->{\textbf{Inneficient collisions}} & \onslide<3->{\textbf{Efficient collisions}}\\
\onslide<2->{
...
\onslide<2->{Thermal non-equilibrium} & \onslide<3->{Thermal equilibrium}
\end{tabular}
\end{center}

\onslide<3->{\textbf{Plasmas are in thermal equilibrium in this work.}}
