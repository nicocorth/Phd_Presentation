...
& \onslide<3->{\includegraphics[height = .2 \linewidth]{./plasmatron_nozzle_operating.png}} \\
...
\begin{framed}
\textbf{Le but de cette thèse est de développer un nouveau solver capable de représenter }
\end{framed}
