...
\begin{framed}
\textbf{FV require a highly refined mesh in regions of large solution gradient.}

\textbf{FV can be very dissipative, "smoothing" the physics.}
\end{framed}
...
\begin{framed}
\begin{equation*}
\partial^2_{zz} E_P + \frac{1}{r}\partial_r (r \partial_r E_P) - \frac{E_P}{r^2} = i 2 \pi f\mu_0\only<3>{\sigma_e} \only<4>{\textcolor{red}{\sigma_e}} \left(E_C + E_P\right)
\end{equation*}
...
& \forall \mu_{e,i} \in M_h, \; \forall \varphi_{K,i} \in W_h, \; \forall \vectau_{K,i} \in V_h
\end{aligned}
\end{equation*}
\end{framed}
\centering
...
\begin{equation*}
CFL_k = \min\left(CFL_0 \left(\frac{||\Tilde{\mathcal{N}}||_2^0}{||\Tilde{\mathcal{N}}||_2^k}\right)^\alpha, CFL_{max}\right)
\end{equation*}
...
DOFs $w \simeq \SI{2 000 000}{}$

DOFS $q \simeq 400 000$
