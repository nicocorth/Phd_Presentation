...
\textbf{FV can be very dissipative, smoothing small scale phenomena.}
\end{framed}
...
\end{tabular}
\begin{framed}
For large scales ($> \SI{1}{\micro\meter}$ in our case), $q \simeq 0$ due to electric force.
\end{framed}
\end{frame}
...
\begin{framed}
\textbf{"Cold plasmas" store energy in the free electrons. It is then transmitted during collisions to the ions et neutrals.}
\end{framed}
...
\onslide<1->
{
\item\textbf{Collision-dominated and thermal plasma}
}
...
\onslide<3->
{
\item\textbf{No displacement current}
}
...
\onslide<5->
{
\item\textbf{Optically thick plasma}
}

\onslide<6->
{
\item\textbf{Local thermodynamic equilibrium}
}

\onslide<7->
{
\item\textbf{No elemental de-mixing}
}

\onslide<8->
{
\item\textbf{Unmagnetized plasma}
}
...
\begin{frame}{Transport properties : viscosity}
\centering
\begin{minipage}{0.49\linewidth}
\input{./mu}
\end{minipage}
...
\begin{frame}{Transport properties : heat conductivity}
\centering
...
\begin{frame}{Transport properties : electric conductivity}
\centering
\input{./sigma_e}
\end{frame}
