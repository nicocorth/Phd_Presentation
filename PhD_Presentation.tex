...
\end{tabular}
\begin{framed}
On sufficiently large scales ($> \SI{1}{\micro\meter}$ in our case), the electric neutrality of the plasma is guaranteed by the long range collisions (electric force).
\end{framed}
\end{frame}
...
\begin{center}
\begin{tabular}{cc}
\textbf{Inneficient collisions} & \textbf{Efficient collisions}\\
