...
\begin{framed}
\textbf{Pour les "plasmas froids", l'énergie est d'abord emmagasinée par les électrons libres et cédée lors des collisions aux ions et neutres lourds.}
\end{framed}
...
{
\begin{framed}
\textbf{Les volumes finis nécessitent un maillage de bonne qualité, et donc très fin dans les régions de grande variation ou de géométrie complexe}
\end{framed}
...
\onslide<5->
{
\item\textbf{Non-radiative plasma}
}
...
Characteristic length $\gg$ Debye length
\begin{equation*}
...
\begin{equation*}
\vecq = \nabla \vecu \simeq \vecq_h = \sum_{K\in\mathcal{T}}\sum_{i=1}^{p} \vecq_{K,i} \vectau_{K,i}
\end{equation*}
with the subset
\begin{equation*}
...
\begin{equation*}
	\begin{aligned}
		& \partial_t \rho + \nabla \cdot \left(\rho \vecv\right) =0\\
		& \partial_t \left(\rho \vecv\right) + \nabla \cdot \left(\rho \vecv \vecv\right) + \nabla p - \nabla \cdot \vectau = \textcolor{red}{\gamma \left.\vecF^L\right|_{I_c = \SI{1}{\ampere}}}\\
		& \partial_t \left(\rho e + \frac{1}{2} \rho ||\vecv||^2\right) + \nabla \cdot \left(\rho e \vecv + \frac{1}{2} \rho ||\vecv||^2 \vecv + p \vecv - \vectau \cdot \vecv - \vecq\right) = \textcolor{red}{\gamma \left.P_J\right|_{I_c = \SI{1}{\ampere}}}\\
	\end{aligned}
\end{equation*}

\begin{equation*}
	\Delta \textcolor{red}{\left.E_P\right|_{I_c = \SI{1}{\ampere}}} = \frac{\textcolor{red}{\left.E_P\right|_{I_c = \SI{1}{\ampere}}}}{r^2} + i 2 \pi f\mu_0\sigma_e \left(\textcolor{red}{\left.E_C\right|_{I_c = \SI{1}{\ampere}}} + \textcolor{red}{\left.E_P\right|_{I_c = \SI{1}{\ampere}}}\right)
\end{equation*}
}
\end{frame}
...
$\gamma$ is computed at every Newton iteration and used to scale $\left.P_J\right|_{I_c = \SI{1}{\ampere}}$ and $\left.\vecF^L\right|_{I_c = \SI{1}{\ampere}}$. The true electric fields are given by
\begin{equation*}
